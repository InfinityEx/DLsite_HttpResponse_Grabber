...
# fadata=requests.post('https://comic.dragalialost.com/api/index',headers=headers,data=params)
fadata=requests.post('https://comic.dragalialost.com/api/thumbnail_list/1',headers=headers,data=params)
fadata=fadata.json()
print(fadata)
# gdata=fdata.json()
